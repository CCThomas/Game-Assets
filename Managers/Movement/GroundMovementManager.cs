...
public class GroundMovementManager : AbstractMovementManager
{
    ...
    public override void OnTriggerStay(Collider collider)
    {
        ...
        if (collider.gameObject.layer == WATER_INDEX
            && collider.transform.position.y > graphics.Find("Armature/Hip/Stomach/Chest").position.y
    ...
    private bool CanGrabHold(Vector3 lookingDirection)
    {
        ...
        {
            raycastHit = hit;
            Debug.Log("movementManager=" + raycastHit.collider);
            return true;
        }
        return false;
    }
